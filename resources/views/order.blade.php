...
@section('main')
    ...
    <div class="container">
        ...
        <br/>
        <h4>Buyer: <a href="/profile/<?php echo $buyer->id ?>">{{ $buyer->name }}</a> <a href="/chat/<?php echo $buyer->id ?>">Chat</a></h4>
        @if ($deliverer)
        ...
        @if (Auth::check() && Auth::user()->id != $order->buyer_id && !$order->deliverer_id)
            ...
            <input required name="amount" type="number" step="0.10" class="form-control text-center"/>
