        ...
        {!! Form::open() !!}
            <div class="form-group">
				<div class="input-group col-xs-6">
                    <span class="input-group-addon" id="basic-addon2">Comment to seller:</span>
                    <input type="text" class="form-control" placeholder="e.g. allergic to peanuts" required/>
                </div>
            ...
            <center class="cart_buttons">
				<a href="/" class="btn btn-success" id="cart_cancel">Cancel Order</a>
